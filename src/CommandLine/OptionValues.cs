...
namespace Orang.CommandLine
{
    internal static class OptionValues
    {
        ...
        public static readonly SimpleOptionValue PatternOptions_Negative = SimpleOptionValue.Create(PatternOptions.Negative, shortValue: "e", helpValue: "n[e]gative", description: "Search succeeds if the regular expression does not match.");
